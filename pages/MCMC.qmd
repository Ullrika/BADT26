...
2. $p_{prop}=\frac{poposal}{current}$.
...
1. making a proposal and knowing the population of the proposal

2. knowing the population of the current, to calculate $p_{prop}=\frac{proposal}{current}$.

3. generate a random value between [0,1] and compare with $p_{prop}$.
...
Complete Ex 3: today and beginning of tomorrow. 
